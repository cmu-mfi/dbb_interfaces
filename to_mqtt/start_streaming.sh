...
tmux send-keys -t DDB_UPSTREAM:lfs_mqtt 'python3 to_mqtt/lfs_mqtt/lfs_mqtt.py' C-m

create_window "DDB_UPSTREAM" "ros_mqtt_cfs"
tmux send-keys -t DDB_UPSTREAM:ros_mqtt_cfs 'python3 to_mqtt/ros_mqtt_cfs/ros_mqtt_cfs.py' C-m
